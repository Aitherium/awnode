...
interesting failures live BETWEEN them. "awnode is installed" is not the useful
fact -- "awnode is installed and the thing it pairs with is not" is. This reports
...
SELF = 'awnode'
FAMILY = ['awask', 'awask', 'awbac', 'awbrowse', 'awdit', 'awevolve', 'awevolve', 'awfind', 'awgit', 'awgraph', 'awiam', 'awkno', 'awm', 'awmail', 'awnboard', 'awnest', 'awnet', 'awpredict', 'awprism', 'awreason', 'awrecover', 'awrecurse', 'awrelay', 'awrepl', 'awresearch', 'awrun', 'awseal', 'awshare', 'awtunnel']
PAIRS_WITH = ['adk']
...
#: gets ignored.
ENV_REQUIRED = ['AITHERNODE_MODE', 'AITHERNODE_PORT']
ENV_OPTIONAL = ['AITHERNODE_BIND_HOST', 'AITHERNODE_FS_ROOT', 'AITHERNODE_PROXY_MAP', 'AITHERNODE_PROXY_TOKEN', 'AITHERNODE_SERVICE_HOST', 'AITHERNODE_TRUSTED_PROXIES']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awnode needs at runtime, and a
