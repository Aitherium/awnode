...
# aither-llamacpp-bonsai container is 8092; standalone installs can point this
...
async def mcp_jsonrpc(request: Request):
    """Minimal JSON-RPC surface for tools/list (what AitherConnect node tier
...
#
# Lets any OpenAI-style client (the AitherConnect extension's provider tier,
...
async def _resolve_backend_model(base: str, model: str) -> str:
    ...
    The AitherConnect extension sends model="auto" in node tier; vLLM and
