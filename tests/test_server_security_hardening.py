...
def test_check_origin_validation():
    ...
    assert _check_origin(MockRequest("https://aitherium.com")) is True
    ...
    # Pinned: a tenant-hosted subdomain, plain http and a suffix look-alike are refused.
    assert _check_origin(MockRequest("https://subdomain.aitherium.com")) is False
    assert _check_origin(MockRequest("http://portal.aitherium.com")) is False
    assert _check_origin(MockRequest("https://evilaitherium.com")) is False
    assert _check_origin(MockRequest("")) is False
    assert _check_origin(MockRequest("ftp://aitherium.com")) is False
